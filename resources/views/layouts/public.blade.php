        ...
        <div class="container">
            <div class="row gy-4">
                ...
                <div class="col-lg-4 col-md-12">
                    ...
                    <div class="mt-4">
                        <!-- Botón de TikTok (Se muestra si hay link) -->
                        @if(!empty($linkTiktok))
                        <a href="{{ $linkTiktok }}" target="_blank" class="btn btn-outline-light rounded-circle me-2 d-inline-flex justify-content-center align-items-center" style="width: 45px; height: 45px; border-color: rgba(255,255,255,0.2);">
                            <i class="fa-brands fa-tiktok fs-5"></i>
                        </a>
                        @endif

                        <!-- Botón de Facebook (Se muestra si hay link) -->
                        @if(!empty($linkFacebook))
                        <a href="{{ $linkFacebook }}" target="_blank" class="btn btn-outline-light rounded-circle me-2 d-inline-flex justify-content-center align-items-center" style="width: 45px; height: 45px; border-color: rgba(255,255,255,0.2);">
                            <i class="fa-brands fa-facebook-f fs-5"></i>
                        </a>
                        @endif

                        <!-- Botón de Instagram (Se muestra si hay link) -->
                        @if(!empty($linkInstagram))
                        <a href="{{ $linkInstagram }}" target="_blank" class="btn btn-outline-light rounded-circle d-inline-flex justify-content-center align-items-center" style="width: 45px; height: 45px; border-color: rgba(255,255,255,0.2);">
